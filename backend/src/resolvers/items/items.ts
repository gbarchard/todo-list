...
import { ItemResolvers, MutationResolvers, QueryResolvers } from "../../generated/resolvers-types"
...
export const ItemsMutation: Pick<MutationResolvers, 'addItem'|'deleteItem'> = {
  addItem: async (_, { name }, context) => {
    const doc: ItemModel = { _id: new ObjectId(), name, createdDate: context.date }
